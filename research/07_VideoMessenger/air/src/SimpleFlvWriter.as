/*
   ...
   Daniel Wanja
   4-2008 replaced FileStream by ByteArray 
   (TODO: split in two class one the Writer and one the Saver, then can be saved as file or bystream)			
*/
...
//		private var fs:FileStream = new FileStream();
		...
		public function getAndClearFlvBytes():ByteArray {
			var result:ByteArray = fs;
			fs = new ByteArray();
			return result;			
		}
